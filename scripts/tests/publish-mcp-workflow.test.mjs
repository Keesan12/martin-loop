...
test("publish-mcp workflow covers trusted publishing, recovery coordinates, local-pack proof, and published smoke", async () => {
  ...
  assert.match(workflow, /TAG="mcp-v0\.6\.5"/);
  assert.match(workflow, /VALIDATED_RELEASE_SHA="2f6da7e2788bed46092910d02253b9d29b4e9c63"/);
  ...
  assert.match(workflow, /pnpm --filter @martinloop\/mcp version:check/);
