...
export function createStubAgentCliAdapter(options: StubAgentCliAdapterOptions): MartinAdapter {
  ...
  return {
    adapterId: `agent-cli:stub:${options.command.join(":")}`,
    kind: "agent-cli",
...
// Internal test-compatibility re-export. Public builders remove the entire
// stub compatibility surface before constructing distributable packages.
export {
