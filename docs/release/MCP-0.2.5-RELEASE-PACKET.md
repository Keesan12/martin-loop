...
- separate non-OSS product lines remain private tier lanes.
- non-OSS product capabilities remain outside this release note
- Reviewing this packet does not approve promotion of private operation surface, autonomy, or router internals into the OSS package or docs.
...
Focused package checks confirm the local MCP line still matches the documented public surface.

## Versions Tested

- root package local integrated tree: `martin-loop@0.1.6`
- standalone MCP local integrated tree: `@martinloop/mcp@0.2.5`
- private control plane local integrated tree: `@martin/operation surface@0.2.5-local`
