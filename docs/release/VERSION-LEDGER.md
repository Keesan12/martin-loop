...
- live npm dist-tag `latest`: `0.6.7`
- live public GitHub release: `v0.6.7`
- live public baseline in this train: `0.6.7`
- root public baseline: `0.6.7`
...
- current in-repo root release target: `0.6.8` (pending publication)
- next planned root follow-on: not scheduled

## Standalone package: `@martinloop/mcp`

- live npm dist-tag `latest`: `0.6.7`
- live public GitHub release: `mcp-v0.6.7`
- live public baseline in this train: `0.6.7`
- standalone MCP public baseline: `0.6.7`
- official MCP Registry version: `0.5.5` (verified)
- live MCPB baseline: `0.6.7`
- live MCPB SHA-256: see the `mcp-v0.6.7` GitHub release checksum asset
- live MCPB size: see the `mcp-v0.6.7` GitHub release asset
- current in-repo standalone release target: `0.6.8` (pending publication)
- current in-repo MCPB release target: `0.6.8` with manifest schema `0.3` (pending publication)
...
- The `0.6.8` train advances the root package, standalone MCP package, plugin metadata, and MCPB product version to `0.6.8` (pending publication). MCPB manifest schema remains `0.3`.
