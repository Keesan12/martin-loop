...
- live npm dist-tag `latest`: `0.3.13` (0.3.14 pending merge of fix/e-full-env-debug)
- live public GitHub release: `v0.3.13`
- live public baseline in this train: `0.3.14`
- root public baseline: `0.3.14`
