...
- current in-repo root release line: `0.3.2` for the current public root package line
- next planned root follow-on: `0.3.3` for additional cross-host reliability follow-ups
