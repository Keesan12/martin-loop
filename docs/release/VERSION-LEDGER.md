...
- live npm dist-tag `latest`: `0.3.6` before the `0.3.7` reliability release publishes
- live public GitHub release: `v0.3.6` before the `v0.3.7` release workflow completes
- live public baseline in this train: `0.3.6`
- root public baseline: `0.3.6`
...
- current in-repo root release line: `0.3.7` for run-store reliability hardening across CLI/MCP inspection paths
- next planned root follow-on: `0.3.8` for additional cross-host reliability follow-ups
...
- current in-repo standalone release line: `0.3.3` for opt-in execution controls and run-history reliability hardening
- next planned standalone release: `0.3.4` for additional host-coverage follow-ups
