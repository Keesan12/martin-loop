...
- Failure taxonomy is canonical runtime-derived from `FAILURE_CLASSES` in `@martin/contracts`; see [`FAILURE-TAXONOMY.md`](./FAILURE-TAXONOMY.md) and [`failure-taxonomy.runtime.json`](./failure-taxonomy.runtime.json).
