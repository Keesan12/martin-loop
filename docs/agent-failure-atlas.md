...
The public canonical subset is the runtime taxonomy documented in [./oss/FAILURE-TAXONOMY.md](./oss/FAILURE-TAXONOMY.md). Legacy operational labels are replay-only aliases in [./oss/FAILURE-TAXONOMY-ALIASES.md](./oss/FAILURE-TAXONOMY-ALIASES.md). Use this atlas for the extended catalog.
